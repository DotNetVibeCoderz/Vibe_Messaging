# BlackHole Messaging — documentation
...
Angka benchmark ada di [benchmarks.md](benchmarks.md) (berbahasa Inggris).

## Screenshots

![The IoT Gateway panel](images/gateway-panel.png)

![Streaming a firmware upload](images/gateway-streaming.png)

## Raw data

[benchmark-run.txt](benchmark-run.txt) — the unedited output behind the benchmark tables.
